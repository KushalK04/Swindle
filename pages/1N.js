...
export default function OneN() {
  ...
  const handleNoClick = () => {
    updateSelections('Is the message saying that the device you are using has a virus and needs to run a scan?', 'No')
  }

  const handleYesClick = () => {
    updateSelections('Is the message saying that the device you are using has a virus and needs to run a scan?', 'Yes')
  }
      ...
      <main className={styles.main}>
        ...
        <div className={styles.contentContainer}>
          ...
          <div className={styles.buttoncontainer}>
            ...
            <Link href="/1Q"><button className={styles.button} onClick={handleNoClick}><h4>{no}</h4></button></Link>                
          </div>
        </div>
        <BottomNav/>
      </main>
