...
export default function OneZ() {
  ...
  const handleNoClick = () => {
    updateSelections('Does this link look like it is from something familiar or legitimate?', 'No')
  }

  const handleYesClick = () => {
    updateSelections('Does this link look like it is from something familiar or legitimate?', 'Yes')
  }
