      ...
      <main className={styles.main}>
        ...
        <div className={styles.contentContainer}>
          ...
          <div className={styles.buttoncontainer}>
            <Link href="/LinkFamiliar"><button className={styles.button} onClick={handleYesClick}><h4>{yes}</h4></button></Link>
            <Link href="/AskingForMoney"><button className={styles.button} onClick={handleNoClick}><h4>{no}</h4></button></Link>
          </div>
        </div>
        <BottomNav/>
      </main>
