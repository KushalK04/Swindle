...
export default function OneW() {
  ...
  const handleNoClick = () => {
    updateSelections('Is the message asking you to go to a link?', 'No')
  }

  const handleYesClick = () => {
    updateSelections('Is the message asking you to go to a link?', 'Yes')
  }
      ...
      <main className={styles.main}>
        ...
        <div className={styles.contentContainer}>
          ...
          <div className={styles.buttoncontainer}>
            <Link href="/LinkFamiliar2"><button className={styles.button} onClick={handleYesClick}><h4>{yes}</h4></button></Link>
            <Link href="/NotName"><button className={styles.button} onClick={handleNoClick}><h4>{no}</h4></button></Link>
          </div>
        </div>
        <BottomNav/>
